...
export default function AgendaPage() {
  return (
    <ModuleLayout title="Cronograma de Medição" subtitle="DIREX • Módulo de Agendamento">
      <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-6">
        ...
        <p className="text-slate-500 font-bold uppercase tracking-widest text-[10px] mb-8 max-w-sm mx-auto leading-relaxed">
          O calendário unificado de vistorias técnicas e medições está sendo sincronizado.
        </p>
      </div>
    </ModuleLayout>
  );
